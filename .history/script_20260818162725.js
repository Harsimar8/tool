...
const symbolVariants = {
    ...
    Radar: [
        ...
        {
            name: "Ground Surveillance / Target Acquisition Radar",
            sidc: "SFGPUCR----F"
        },
        ...
        {
            name: "Ground Track Signal Early Warning Radar",
            sidc: "SFGPUCA----F"
        },

        {
            name: "Ground Track Signal Fire Control Radar",
            sidc: "SFGPUCF----F"
        }
...
function openSymbolPicker(event, category) {
    ...
    variants.forEach(variant => {
        ...
        const milSymbol = createMilSymbol(
            variant.sidc,
            55
        );
...
function selectOrbatSymbol(category, variant, button) {
    ...
    if (
        ...
        showNotification(category + " deselected");
        setStatus(category + " deselected");
